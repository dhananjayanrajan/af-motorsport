...
const DUMMY_ARCHIVE = [
  { id: 1, name: "CONSTRUCTORS CHAMPIONSHIP", type: "PREMIER LEAGUE", beneficiary: "AF MOTORSPORT", basics: { description: "Highest technical honor for aerodynamic efficiency and powertrain reliability across the 2026 season." }, details: { prestige: 'Iconic', exclusivity: 'TeamOnly' }, assets: { primary: "https://images.unsplash.com/photo-1579546673283-41a1871fd75c?q=80&w=1200" } },
  { id: 2, name: "GALA OF EXCELLENCE", type: "CELEBRATION", beneficiary: "V-CORP TEAM", basics: { description: "Annual recognition of strategic intelligence and trackside operational perfection." }, details: { prestige: 'Prestigious', exclusivity: 'InviteOnly' }, assets: { primary: "https://images.unsplash.com/photo-1511795409834-ef04bbd61622?q=80&w=1200" } },
  { id: 3, name: "INNOVATION IN CARBON", type: "TECHNICAL AWARD", beneficiary: "CHIEF ARCHITECT", basics: { description: "Awarded for the development of the zero-flex chassis architecture used in the V-01 series." }, details: { prestige: 'Notable', exclusivity: 'Public' }, assets: { primary: "https://images.unsplash.com/photo-1518709268805-4e9042af9f23?q=80&w=1200" } },
  { id: 4, name: "AERODYNAMIC PINNACLE", type: "DESIGN AWARD", beneficiary: "AERO DEPT", basics: { description: "Validation of the active-floor modeling system implemented during the mid-season upgrade." }, details: { prestige: 'Notable', exclusivity: 'TeamOnly' }, assets: { primary: "https://images.unsplash.com/photo-1503376780353-7e6692767b70?q=80&w=1200" } },
  { id: 5, name: "STRATEGIC MASTERY", type: "TACTICAL AWARD", beneficiary: "OPERATIONS", basics: { description: "Flawless execution of the 4-stop strategy during the Monsoon Grand Prix." }, details: { prestige: 'Prestigious', exclusivity: 'InviteOnly' }, assets: { primary: "https://images.unsplash.com/photo-1552664730-d307ca884978?q=80&w=1200" } },
  { id: 6, name: "PIT STOP RECORD", type: "PERFORMANCE", beneficiary: "PIT CREW", basics: { description: "Consistency award for maintaining sub-2.0s stops across 22 races." }, details: { prestige: 'Notable', exclusivity: 'Public' }, assets: { primary: "https://images.unsplash.com/photo-1533130061792-64b345e4a833?q=80&w=1200" } },
  { id: 7, name: "ZERO EMISSION LEAD", type: "SUSTAINABILITY", beneficiary: "R&D LABS", basics: { description: "Recognition for hydrogen-hybrid integration in transport logistics." }, details: { prestige: 'Notable', exclusivity: 'Public' }, assets: { primary: "https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?q=80&w=1200" } },
  { id: 8, name: "ENGINEERING LEGACY", type: "LIFETIME AWARD", beneficiary: "CEO", basics: { description: "Special recognition for 10 years of advancing high-performance engineering." }, details: { prestige: 'Iconic', exclusivity: 'InviteOnly' }, assets: { primary: "https://images.unsplash.com/photo-1563986768609-322da13575f3?q=80&w=1200" } },
  { id: 9, name: "DATA SOVEREIGNTY", type: "INTELLIGENCE", beneficiary: "IT DIVISION", basics: { description: "Award for building the first fully air-gapped race telemetry server." }, details: { prestige: 'Notable', exclusivity: 'Private' }, assets: { primary: "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=1200" } },
  { id: 10, name: "VICTORY DINNER 26", type: "CELEBRATION", beneficiary: "ENTIRE ORG", basics: { description: "Final end-of-season banquet celebrating triple championship success." }, details: { prestige: 'Prestigious', exclusivity: 'InviteOnly' }, assets: { primary: "https://images.unsplash.com/photo-1467810563316-b5476525c0f9?q=80&w=1200" } },
]