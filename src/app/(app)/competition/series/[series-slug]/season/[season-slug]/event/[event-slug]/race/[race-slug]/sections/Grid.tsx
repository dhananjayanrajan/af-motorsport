...
export default function EntryStackedGrid({ entries }: EntryStackedGridProps) {
    return (
        <section className="w-full p-8 sm:p-12 lg:p-20" style={{ backgroundColor: DESIGN_SYSTEM.COLORS.BACKGROUND }}>
            ...
            <div className="columns-1 md:columns-2 gap-px bg-zinc-200 border" style={{ borderColor: DESIGN_SYSTEM.COLORS.ZINC_200 }}>
                        ...
                        >
                            ...
                            <div className="p-8 flex flex-col gap-6">
                                <div className="flex flex-col gap-1">
                                    <span className="text-[8px] font-black uppercase tracking-widest" style={{ color: DESIGN_SYSTEM.COLORS.ZINC_400 }}>
                                ...
                                <div className="grid grid-cols-3 gap-4 pt-6 border-t" style={{ borderColor: DESIGN_SYSTEM.COLORS.ZINC_100 }}>
                                    <div className="flex flex-col">
                                        <span className="text-[7px] font-black uppercase tracking-[0.2em]" style={{ color: DESIGN_SYSTEM.COLORS.ZINC_400 }}>Grid</span>
                                    ...
                                    <div className="flex flex-col">
                                        <span className="text-[7px] font-black uppercase tracking-[0.2em]" style={{ color: DESIGN_SYSTEM.COLORS.ZINC_400 }}>Finish</span>
                                        <span className="text-lg font-black italic tabular-nums" style={{ color: DESIGN_SYSTEM.COLORS.PRIMARY }}>P{entry.details.finish_position || '--'}</span>
                                    </div>
                                    <div className="flex flex-col">
                                        <span className="text-[7px] font-black uppercase tracking-[0.2em]" style={{ color: DESIGN_SYSTEM.COLORS.ZINC_400 }}>Plate</span>
