...
export default function SeriesHero({ series }: SeriesHeroProps) {
    ...
    const statusColors: Record<string, string> = {
        ...
        Inactive: DESIGN_SYSTEM.COLORS.ZINC_500,
        Defunct: DESIGN_SYSTEM.COLORS.ZINC_700,
        Upcoming: DESIGN_SYSTEM.COLORS.ZINC_600,
    };

    const statusColor = series.details?.status
        ? statusColors[series.details.status] || DESIGN_SYSTEM.COLORS.ZINC_600
            ...
            <div className="flex-none lg:w-[500px] flex flex-col justify-between p-8 sm:p-12 lg:p-16 border-l" style={{ backgroundColor: DESIGN_SYSTEM.COLORS.SURFACE, borderColor: DESIGN_SYSTEM.COLORS.ZINC_100 }}>
                <div className="flex flex-col gap-8 sm:gap-12">
                    ...
                    <div className="flex flex-col gap-4">
                        <span className="text-[10px] font-black uppercase tracking-widest" style={{ color: DESIGN_SYSTEM.COLORS.ZINC_300 }}>Description</span>
                    ...
                    <div className="grid grid-cols-2 gap-px border shadow-sm" style={{ backgroundColor: DESIGN_SYSTEM.COLORS.ZINC_100, borderColor: DESIGN_SYSTEM.COLORS.ZINC_100 }}>
                        <div className="p-4 sm:p-6 flex flex-col gap-1" style={{ backgroundColor: DESIGN_SYSTEM.COLORS.SURFACE }}>
                            <span className="text-[8px] font-black uppercase tracking-widest" style={{ color: DESIGN_SYSTEM.COLORS.ZINC_400 }}>Inception</span>
                        ...
                        <div className="p-4 sm:p-6 flex flex-col gap-1" style={{ backgroundColor: DESIGN_SYSTEM.COLORS.SURFACE }}>
                            <span className="text-[8px] font-black uppercase tracking-widest" style={{ color: DESIGN_SYSTEM.COLORS.ZINC_400 }}>Duration</span>
                            <span className="text-xl sm:text-2xl font-black italic tabular-nums" style={{ color: series.details?.end_date ? DESIGN_SYSTEM.COLORS.BLACK : DESIGN_SYSTEM.COLORS.PRIMARY }}>
                ...
                <div className="flex flex-col gap-4 sm:gap-6 mt-12 sm:mt-16">
                    <span className="text-[9px] font-black uppercase tracking-widest" style={{ color: DESIGN_SYSTEM.COLORS.ZINC_400 }}>Sequential History</span>
                            ...
                            >
                                <div className="flex items-center gap-3 sm:gap-4">
                                    <div className="w-8 h-8 flex items-center justify-center border transition-colors duration-200" style={{ borderColor: DESIGN_SYSTEM.COLORS.ZINC_200 }}>
                                        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" className="transition-colors duration-200" style={{ color: DESIGN_SYSTEM.COLORS.ZINC_400 }}>
                                            <path d="M19 12H5M12 19l-7-7 7-7" />
                                        </svg>
                                    </div>
                                    <div className="flex flex-col">
                                        <span className="text-[7px] font-black uppercase tracking-widest" style={{ color: DESIGN_SYSTEM.COLORS.ZINC_400 }}>Preceding</span>
                                        <span className="text-xs font-black uppercase italic" style={{ color: DESIGN_SYSTEM.COLORS.BLACK }}>{predecessor.name}</span>
                                    </div>
                                </div>
                            </Link>
                        ) : (
                            <div className="p-4 sm:p-5 flex items-center gap-3 sm:gap-4" style={{ backgroundColor: DESIGN_SYSTEM.COLORS.ZINC_50, borderColor: DESIGN_SYSTEM.COLORS.ZINC_50, opacity: 0.4 }}>
                                <div className="w-8 h-8 flex items-center justify-center border" style={{ borderColor: DESIGN_SYSTEM.COLORS.ZINC_200 }}>
                                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" style={{ color: DESIGN_SYSTEM.COLORS.ZINC_300 }}>
                                        <path d="M19 12H5M12 19l-7-7 7-7" />
                                    </svg>
                                </div>
                                <span className="text-[8px] font-black uppercase tracking-widest" style={{ color: DESIGN_SYSTEM.COLORS.ZINC_400 }}>Foundation Series</span>
                            </div>
                        )}
                        ...
                        {successor ? (
                            ...
                            >
                                <div className="flex items-center gap-3 sm:gap-4">
                                    ...
                                    <div className="flex flex-col">
                                        <span className="text-[7px] font-black uppercase tracking-widest" style={{ color: DESIGN_SYSTEM.COLORS.ZINC_400 }}>Succeeding</span>
                            ...
                            <div className="p-4 sm:p-5 flex items-center justify-between" style={{ backgroundColor: DESIGN_SYSTEM.COLORS.BLACK }}>
                                <div className="flex items-center gap-3 sm:gap-4">
                                    ...
                                    <div className="flex flex-col">
                                        <span className="text-[7px] font-black uppercase tracking-widest" style={{ color: DESIGN_SYSTEM.COLORS.ZINC_500 }}>Succeeding</span>
