...
const HyperspeedSection: React.FC<HyperspeedSectionProps> = ({
    ...
    return (
        ...
        >
            ...
            <div className="relative w-full h-auto md:h-[700px] flex flex-col md:flex-row border-b border-black-pure">
                <div className="w-full md:w-1/2 flex flex-col bg-white-pure border-r border-black-pure">
                    {routes.map((route, idx) => (
                        <Link
                            key={route.id}
                            href={resolvePath(route)}
                            className="flex-1 group relative flex items-center border-b border-black-pure last:border-b-0 hover:bg-black-pure focus:bg-black-pure focus:outline-none transition-colors duration-200 py-8 md:py-0"
                        >
                            ...
                            <div className="w-full flex items-center px-8 md:px-12">
                                <div className="flex items-center justify-center border-r border-black-pure pr-8 md:pr-12 mr-8 md:mr-12">
                                ...
                                <div className="flex-1 flex items-center justify-between min-w-0">
                                    ...
                                    <div className="w-10 h-10 bg-white-pure border border-black-pure group-hover:bg-primary-500 group-hover:border-primary-500 flex items-center justify-center transition-all duration-300 group-hover:scale-110">
                                        <svg
                                            width="14"
                                            height="14"
                                            viewBox="0 0 24 24"
                ...
                <div className="w-full md:w-1/2 h-[400px] md:h-full relative bg-black-pure overflow-hidden">
                    ...
                    <div className="relative z-10 h-full w-full flex flex-col justify-end">
                        <div className="grid grid-cols-2 bg-black-pure border-t border-black-pure">
                            {routes.map((route) => (
                                <Link
                                    key={`stat-${route.id}`}
                                    href={resolvePath(route)}
                                    className="group p-5 border-r border-b border-black-pure last:border-r-0 flex flex-col gap-3 bg-white-pure hover:bg-black-pure transition-all duration-200"
                                >
                                    ...
                                    <div className="flex justify-between items-end gap-3">
                                        ...
                                        <div className="bg-black-pure text-white-pure px-2 py-0.5 border border-black-pure group-hover:bg-white-pure group-hover:text-black-pure transition-colors">
