      ...
      <div className="bg-black min-h-screen">
        <div className="border-b border-zinc-900 bg-zinc-950/50 sticky top-0 z-40 backdrop-blur-md">
          <div className="container h-16 flex items-center justify-between">
            <Link href="/shop" style={{ color: DESIGN_SYSTEM.COLORS.PRIMARY }} className="group flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.3em] transition-colors brightness-50 hover:brightness-100">
            ...
            <div className="flex items-center gap-6">
              <div className="flex items-center gap-2">
                ...
                />
                <span className="text-[9px] font-mono text-zinc-400 uppercase tracking-widest">{hasStock ? 'Unit_Available' : 'Out_of_Stock'}</span>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="sticky top-32">
                ...
                <div className="mt-12 grid grid-cols-3 gap-px bg-zinc-900 border border-zinc-900">
                  {[
                    ...
                    <div key={i} className="bg-black p-6 flex flex-col gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] font-bold text-white uppercase italic">{item.status}</p>
                      </div>
                    </div>
                  ))}
                </div>
        ...
        {relatedProducts.length ? (
          <div className="border-t border-zinc-900 bg-black py-24">
            <div className="container">
              <div className="flex items-center gap-4 mb-12">
                <h2 className="text-3xl font-black italic text-white uppercase tracking-tighter">Related_Hardware</h2>
    ...
    <ul className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
      {products.map((product) => (
        <li key={product.id} className="group">
          <Link className="block relative aspect-square overflow-hidden bg-zinc-900 transition-transform group-hover:-translate-y-2"
          ...
          <div className="mt-4">
            ...
            />
            <p className="text-[10px] font-black text-zinc-500 uppercase tracking-widest truncate">{product.title}</p>
          </div>
        </li>
      ))}
    </ul>
