...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "payload_mcp_api_keys" (
  	...
  	"narratives_find" boolean DEFAULT false,
  	"narratives_create" boolean DEFAULT false,
  	"narratives_update" boolean DEFAULT false,
  	"narratives_delete" boolean DEFAULT false,
  	"stories_find" boolean DEFAULT false,
  	"stories_create" boolean DEFAULT false,
  	"stories_update" boolean DEFAULT false,
  	"stories_delete" boolean DEFAULT false,
  	"histories_find" boolean DEFAULT false,
  	"histories_create" boolean DEFAULT false,
  	"histories_update" boolean DEFAULT false,
  	"histories_delete" boolean DEFAULT false,
  	"journeys_find" boolean DEFAULT false,
  	"journeys_create" boolean DEFAULT false,
  	"journeys_update" boolean DEFAULT false,
  	"journeys_delete" boolean DEFAULT false,
  	"notes_find" boolean DEFAULT false,
  	"notes_create" boolean DEFAULT false,
  	"notes_update" boolean DEFAULT false,
  	"notes_delete" boolean DEFAULT false,
  	...
  	"kits_find" boolean DEFAULT false,
  	"kits_create" boolean DEFAULT false,
  	"kits_update" boolean DEFAULT false,
  	"kits_delete" boolean DEFAULT false,
  	...
  	"galleries_find" boolean DEFAULT false,
  	"galleries_create" boolean DEFAULT false,
  	"galleries_update" boolean DEFAULT false,
  	"galleries_delete" boolean DEFAULT false,
  	"playlists_find" boolean DEFAULT false,
  	"playlists_create" boolean DEFAULT false,
  	"playlists_update" boolean DEFAULT false,
  	"playlists_delete" boolean DEFAULT false,
  	"archives_find" boolean DEFAULT false,
  	"archives_create" boolean DEFAULT false,
  	"archives_update" boolean DEFAULT false,
  	"archives_delete" boolean DEFAULT false,
  	"visualizations_find" boolean DEFAULT false,
  	"visualizations_create" boolean DEFAULT false,
  	"visualizations_update" boolean DEFAULT false,
  	"visualizations_delete" boolean DEFAULT false,
  	"schedules_find" boolean DEFAULT false,
  	"schedules_create" boolean DEFAULT false,
  	"schedules_update" boolean DEFAULT false,
  	"schedules_delete" boolean DEFAULT false,
  	...
  	"careers_find" boolean DEFAULT false,
  	"careers_create" boolean DEFAULT false,
  	"careers_update" boolean DEFAULT false,
  	"careers_delete" boolean DEFAULT false,
  	...
  	"protocols_delete" boolean DEFAULT false,
  	"duties_find" boolean DEFAULT false,
  	"duties_create" boolean DEFAULT false,
  	"duties_update" boolean DEFAULT false,
  	"duties_delete" boolean DEFAULT false,
  	"expectations_find" boolean DEFAULT false,
  	"expectations_create" boolean DEFAULT false,
  	"expectations_update" boolean DEFAULT false,
  	"expectations_delete" boolean DEFAULT false,
  	"highlights_find" boolean DEFAULT false,
  	"highlights_create" boolean DEFAULT false,
  	"highlights_update" boolean DEFAULT false,
  	"highlights_delete" boolean DEFAULT false,
  	...
  	"impacts_find" boolean DEFAULT false,
  	"impacts_create" boolean DEFAULT false,
  	"impacts_update" boolean DEFAULT false,
  	"impacts_delete" boolean DEFAULT false,
  	"decisions_find" boolean DEFAULT false,
  	"decisions_create" boolean DEFAULT false,
  	"decisions_update" boolean DEFAULT false,
  	"decisions_delete" boolean DEFAULT false,
  	"strategies_find" boolean DEFAULT false,
  	"strategies_create" boolean DEFAULT false,
  	"strategies_update" boolean DEFAULT false,
  	"strategies_delete" boolean DEFAULT false,
  	...
  	"experiences_find" boolean DEFAULT false,
  	"experiences_create" boolean DEFAULT false,
  	"experiences_update" boolean DEFAULT false,
  	"experiences_delete" boolean DEFAULT false,
  	...
  	"tones_find" boolean DEFAULT false,
  	"tones_create" boolean DEFAULT false,
  	"tones_update" boolean DEFAULT false,
  	"tones_delete" boolean DEFAULT false,
  	"features_find" boolean DEFAULT false,
  	"features_create" boolean DEFAULT false,
  	"features_update" boolean DEFAULT false,
  	"features_delete" boolean DEFAULT false,
  	"specifications_find" boolean DEFAULT false,
  	"specifications_create" boolean DEFAULT false,
  	"specifications_update" boolean DEFAULT false,
  	"specifications_delete" boolean DEFAULT false,
  	"classifications_find" boolean DEFAULT false,
  	"classifications_create" boolean DEFAULT false,
  	"classifications_update" boolean DEFAULT false,
  	"classifications_delete" boolean DEFAULT false,
  	...
  	"principles_find" boolean DEFAULT false,
  	"principles_create" boolean DEFAULT false,
  	"principles_update" boolean DEFAULT false,
  	"principles_delete" boolean DEFAULT false,
  	"preferences_find" boolean DEFAULT false,
  	"preferences_create" boolean DEFAULT false,
  	"preferences_update" boolean DEFAULT false,
  	"preferences_delete" boolean DEFAULT false,
  	"channels_find" boolean DEFAULT false,
  	"channels_create" boolean DEFAULT false,
  	"channels_update" boolean DEFAULT false,
  	"channels_delete" boolean DEFAULT false,
