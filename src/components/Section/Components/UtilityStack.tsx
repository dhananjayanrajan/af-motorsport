            ...
            <AnimatePresence>
                {isHovered && (
                    <motion.div
                        ...
                        className="absolute right-16 w-48 p-4 bg-white-pure border-2 border-black-pure shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] pointer-events-none z-[10001]"
                    >
                ...
                <AnimatePresence>
                    {isOpen && (
                        <motion.div
                            ...
                            className="mb-2 w-[350px] max-w-[calc(100vw-3rem)] h-[480px] max-h-[70vh] flex flex-col bg-white-pure border-2 border-black-pure shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]"
                        ...
                        >
                            ...
                            <div className="flex-1 overflow-y-auto chat-scroll p-6 bg-white-pure">
