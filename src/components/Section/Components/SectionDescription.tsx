...
const SectionDescription: React.FC<SectionDescriptionProps> = ({ text, variant = 1 }) => {
    ...
    if (variant === 2) {
        return (
            <div className="group relative overflow-hidden bg-white-pure border-2 border-black-pure">
    ...
    if (variant === 4) {
        return (
            <div className="group border-2 border-black-pure bg-white-pure hover:bg-black-pure transition-colors duration-700">
    ...
    if (variant === 5) {
        return (
            <div className="group grid grid-cols-1 md:grid-cols-[1fr_100px] border-2 border-black-pure bg-white-pure">
    ...
    return (
        <div className="group relative pt-12 px-6 pb-8 md:pt-16 md:px-10 md:pb-10 border-2 border-black-pure bg-white-pure hover:translate-x-1 hover:translate-y-1 transition-all duration-300">
